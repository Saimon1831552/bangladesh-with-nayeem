      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .bdp-hero-grad {
          ...
          background:
            linear-gradient(to top, rgba(10,9,7,.97) 0%, rgba(10,9,7,.55) 42%, transparent 70%),
        ...
        .bdp-featured-pill {
          ...
          background: linear-gradient(135deg,#c8a84b,#e8c96b); color: #5a3d00;
          font-size: 10px; font-weight: 800; text-transform: uppercase; letter-spacing: .12em;
          padding: 6px 14px; border-radius: 100px; margin-bottom: 18px; margin-left: 8px;
        }
        .bdp-hero-title {
        ...
        .bdp-layout {
          ...
          padding: 72px 40px 100px; align-items: start;
        }
        ...
        .bdp-author {
          ...
          border: 1px solid #e8e2d8; margin-bottom: 44px;
          box-shadow: 0 2px 12px rgba(0,0,0,.04);
        }
        .bdp-author-img { width: 54px; height: 54px; border-radius: 50%; object-fit: cover; border: 3px solid #e8e2d8; flex-shrink: 0; }
        .bdp-author-init { width: 54px; height: 54px; border-radius: 50%; background: #d4e8dc; color: #1a5c35; display: flex; align-items: center; justify-content: center; font-family: 'Cormorant Garamond', serif; font-size: 22px; font-weight: 700; flex-shrink: 0; }
        ...
        <div className="bdp-hero">
          <div className="bdp-hero-imgwrap">
            <img
              ...
              src={d.image_url}
              alt={d.title}
              onError={e => { e.target.src = "https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=2000&q=80"; }}
            />
          </div>
        ...
        <div className="bdp-layout">
          ...
          <div>
            ...
            <div className="bdp-author f5">
              {d.author_img
                ? <img src={d.author_img} alt={d.author} className="bdp-author-img" onError={e => e.target.style.display="none"} />
                : <div className="bdp-author-init">{d.author?.charAt(0) || "A"}</div>
              }
              <div style={{ flex: 1 }}>
            ...
            {d.excerpt && (
              <p className="f5" style={{
                ...
                fontSize: "1.32rem", fontStyle: "italic",
                color: "#4a4540", lineHeight: 1.65,
                borderLeft: "3px solid #c8a84b", paddingLeft: 24,
                marginBottom: 40,
              }}>
                {d.excerpt}
              </p>
            ...
            <div className="bdp-body">
              {d.content ? (
                ...
                <>
                  <p>
                    Bangladesh is a land of extraordinary contrasts — where the world's largest mangrove forest meets misty
                    tea-covered hills, where ancient Mughal architecture rises above labyrinthine river deltas, and where
                    the warmth of its people rivals the richness of its landscapes.
                  </p>
                  <blockquote>
                    "Every journey through Bangladesh reveals a layer of beauty and culture that most travelers never discover."
                  </blockquote>
                  <p>
                    Whether you're navigating the narrow channels of the Sundarbans on a silent country boat, sipping fresh
                    Sylheti tea at dawn as mist lifts off the garden rows, or wandering through the incense-heavy lanes of
                    Dhaka's old quarter — this is a destination that rewards the curious and the unhurried.
                  </p>
                  <h2>Planning Your Visit</h2>
                  <p>
                    The ideal window is November through March, when humidity drops, skies clear, and the landscape turns
                    lush after the monsoon. This is when wildlife is most active in the Sundarbans and the waterfalls
                    of Sylhet are at their most dramatic. Advance booking is essential for private tours — particularly
                    for forest permits and cruiser accommodation. Our team handles all logistics so you simply arrive and explore.
                  </p>
                  <h2>What to Bring</h2>
                  <p>
                    Light, moisture-wicking clothing in neutral colours, quality insect repellent, binoculars, and a sense
                    of patient wonder. The Sundarbans reveals itself slowly — a ripple in the water, a shadow moving between
                    the roots — to those who wait and watch.
                  </p>
                </>
              )}
            </div>
            ...
            {d.author && (
              <div className="bdp-card">
                ...
                <div className="bdp-card-body" style={{ textAlign: "center" }}>
                  {d.author_img
                    ? <img src={d.author_img} alt={d.author} style={{ width: 72, height: 72, borderRadius: "50%", objectFit: "cover", border: "3px solid #e8e2d8", margin: "0 auto 14px", display: "block" }} onError={e => e.target.style.display="none"} />
                    : <div style={{ width: 72, height: 72, borderRadius: "50%", background: "#d4e8dc", color: "#1a5c35", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Cormorant Garamond', serif", fontSize: 28, fontWeight: 700, margin: "0 auto 14px" }}>{d.author.charAt(0)}</div>
                  }
