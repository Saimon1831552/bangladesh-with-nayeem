      ...
      <style>{`
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .bdp-hero-grad {
          ...
          background:linear-gradient(to top,rgba(10,9,7,.96) 0%,rgba(10,9,7,.52) 42%,transparent 70%),
                     linear-gradient(to right,rgba(10,9,7,.38) 0%,transparent 60%);
        }
        .bdp-back-btn {
        ...
        .bdp-hero-title { font-family:'Playfair Display',Georgia,serif; font-size:clamp(2.4rem,5.5vw,4.8rem); font-weight:900; color:#fff; line-height:1.06; letter-spacing:-.02em; margin-bottom:22px; }
        ...
        .bdp-info-cell:nth-last-child(-n+2){ border-bottom:none; }
