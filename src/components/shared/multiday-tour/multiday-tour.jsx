...
export default function Multiday() {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/api/tours?tour_type=multiday`)
  ...
  return (
    <div style={{ background: '#f8f6f1', padding: '72px 32px 80px' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        {error ? (
          <p style={{ textAlign: 'center', color: '#ef4444', fontWeight: 600, padding: '40px 0' }}>Failed to load multiday tours. Please refresh.</p>
        ) : loading ? (
          ...
          <p style={{ textAlign: 'center', color: '#9ca3af', padding: '40px 0' }}>No multiday tours available.</p>
        ) : (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 32 }}>
