    ...
    <section className="py-20 bg-green-50/50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 flex justify-center">
          {/* ✅ Fix: <button> inside <Link> → Link styled directly */}
          <Link
            href="/review"
            className="group flex items-center justify-center gap-3 bg-white border-2 border-green-700 text-green-800 hover:bg-green-700 hover:text-white px-8 py-4 rounded-full font-bold transition-all duration-300 shadow-md hover:shadow-lg"
          >
